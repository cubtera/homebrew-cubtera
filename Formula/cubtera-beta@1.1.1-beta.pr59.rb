class CubteraBeta < Formula
  ...
  version "1.1.1-beta.pr59"
  
  on_macos do
    url "https://github.com/cubtera/cubtera/releases/download/v1.1.1-beta.pr59/cubtera-darwin-aarch64-beta.zip"
    sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
  end

  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/cubtera/cubtera/releases/download/v1.1.1-beta.pr59/cubtera-linux-intel-beta.zip"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    else
      url "https://github.com/cubtera/cubtera/releases/download/v1.1.1-beta.pr59/cubtera-darwin-aarch64-beta.zip"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
  ...
  test do
    assert_match "cubtera 1.1.1-beta.pr59", shell_output("#{bin}/cubtera --version", 2)
  end
